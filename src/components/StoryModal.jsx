...
const StoryModal = ({setShowModal, fetchStories}) => {
    ...
    const bgColors = ["#4f46e5","#7c3aed","#db2777","#e11d48","#ca8a04","#ed9488"]
    ...
    <div className='fixed inset-0 z-110 min-h-screen bg-black/80 backdrop-blur text-white flex items-center justify-center p-4'>
        <div className='w-full max-w-md'>
            ...
            <div className='rounded-lg h-96 flex items-center justify-center relative' style={{backgroundColor: background}}>
                {mode === 'text' && (
                    <textarea className='bg-transparent text-white/70 w-full h-full p-6 text-lg resize-none focus:outline-none' placeholder="What's on your mind?" 
            ...
            mt-4 w-full rounded bg-gradient-to-r from-indigo-500 to-purple-600 
