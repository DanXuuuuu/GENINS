...
import { Users, UserPlus, UserCheck, UserRoundPen, MessagesSquare, Vault } from 'lucide-react'
  ...
  <div className='max-w-6xl mx-auto p-6'>
    ...
    <div className='mb-8 flex flex-wrap gap-6'>
      {dataArray.map((item, index)=>(
        <div key={index} className='flex flex-col items-center justify-center gap-1 border h-20 w-40 border-gray-200 bg-white shadpw rounded-md'>
        ...
        {dataArray.find((item)=> item.label ===currentTab).value.map((user)=>(
            <div key={user._id} className='w-full max-w-88 flex gap-5 p-6 bg-white shadow rounded-md'>
                ...
                <div className='flex-1'>
                  ...
                  <div className='flex max-sm:flex max-sm:flex-col gap-2 mt-4'>
                  {
